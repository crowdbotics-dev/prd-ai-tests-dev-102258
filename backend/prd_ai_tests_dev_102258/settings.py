"""
Django settings for prd_ai_tests_dev_102258 project.
...
ROOT_URLCONF = 'prd_ai_tests_dev_102258.urls'
...
WSGI_APPLICATION = 'prd_ai_tests_dev_102258.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_ai_tests_dev_102258 API",
    "DESCRIPTION": "API documentation for prd_ai_tests_dev_102258 App",
    "VERSION": "v1",
}
